      ...
      <nav className="block w-full max-w-full bg-transparent text-white shadow-none rounded-xl transition-all px-0 py-1">
        <div className="flex flex-col-reverse justify-between gap-6 md:flex-row md:items-center">
          <div className="capitalize">
            ...
            <h6 className="block antialiased tracking-normal font-sanFs text-base font-semibold leading-relaxed text-gray-900">
              home
            </h6>
          </div>
                  ...
                  <tr>
                    ...
                    <td className="py-3 px-5 border-b border-blue-gray-50">
                      <div className="w-10/12">
                        ...
                        <div className="flex flex-start bg-blue-gray-50 overflow-hidden w-full rounded-sm font-sans text-xs font-medium h-1">
                          <div className="flex justify-center items-center h-full bg-gradient-to-tr from-blue-600 to-blue-400 text-white w-1/4"></div>
                        </div>
                      </div>
                    </td>
                  </tr>
